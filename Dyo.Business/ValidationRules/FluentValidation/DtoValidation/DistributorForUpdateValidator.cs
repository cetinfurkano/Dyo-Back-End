...
{
    public class DistributorForUpdateValidator:AbstractValidator<DistributorForUpdateDto>
    {
        public DistributorForUpdateValidator()
        {
            ...
            RuleFor(d => d.Password).Cascade(CascadeMode.Stop).Matches(regexForPassword).When(d => !String.IsNullOrEmpty(d.Password));
        }
    }
}
